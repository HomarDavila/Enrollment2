...
namespace Infraestructure.Entity_Configurations
{
    ...
    public class GenderConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Gender>
    {
        public GenderConfiguration()
         : this("Enrollment")
        {
        }
        public GenderConfiguration(string schema)
        {
            ToTable("Genders", schema);
            HasKey(x => x.Id);
