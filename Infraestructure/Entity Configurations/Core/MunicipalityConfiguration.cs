...
namespace Infraestructure.Entity_Configurations
{
    ...
    public class MunicipalityConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Municipality>
    {
        public MunicipalityConfiguration()
         : this("Enrollment")
        {
        }
        public MunicipalityConfiguration(string schema)
        {
            ToTable("Municipalities", schema);
            HasKey(x => x.Id);
