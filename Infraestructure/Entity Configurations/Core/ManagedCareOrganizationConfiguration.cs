...
namespace Infraestructure.Entity_Configurations
{
    ...
    public class ManagedCareOrganizationConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ManagedCareOrganization>
    {
        public ManagedCareOrganizationConfiguration()
         : this("Enrollment")
        {
        }
        public ManagedCareOrganizationConfiguration(string schema)
        {
            ToTable("ManagedCareOrganizations", schema);
            HasKey(x => x.Id);
