...
namespace Infraestructure.Entity_Configurations
{
    ...
    public class ProviderTypeConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ProviderType>
    {
        public ProviderTypeConfiguration()
         : this("Enrollment")
        {
        }
        public ProviderTypeConfiguration(string schema)
        {
            ToTable("ProviderTypes", schema);
            HasKey(x => x.Id);
