...
namespace Infraestructure.Entity_Configurations
{
    ...
    public class PersonPrimaryCarePhysicianConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<PersonPrimaryCarePhysician>
    {
        public PersonPrimaryCarePhysicianConfiguration()
         : this("Enrollment")
        {
        }
        public PersonPrimaryCarePhysicianConfiguration(string schema)
        {
            ToTable("PersonPrimaryCarePhysician", schema);
            HasKey(x => x.Id);
