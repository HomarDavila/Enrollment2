...
namespace Infraestructure.Entity_Configurations
{
    ...
    public class PrimaryCarePhysicianDetailConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<PrimaryCarePhysicianDetail>
    {
        public PrimaryCarePhysicianDetailConfiguration()
         : this("Enrollment")
        {
        }
        public PrimaryCarePhysicianDetailConfiguration(string schema)
        {
            ToTable("PrimaryCarePhysicianDetail", schema);
            HasKey(x => x.Id);
