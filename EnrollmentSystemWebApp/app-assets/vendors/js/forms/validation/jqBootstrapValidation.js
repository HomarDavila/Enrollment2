                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
                            ...
                            message = "La direcci&oacute;n de correo no es v&aacute;lida.<!-- data-validation-email-message to override -->";
                            //HFTM END
        ...
        validatorTypes: {
            ...
            email: {
                ...
                init: function ($this, name) {
                    ...
                    //HFTM BEGIN
                    var message = "La direcci&oacute;n de correo no es v&aacute;lida.";
