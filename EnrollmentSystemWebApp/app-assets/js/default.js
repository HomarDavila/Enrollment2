...
initControls = function () {
    ...
    $.ajax({
        url: 'content/js/cultures/ej.culture.' + $("#culture_switcher").val() + '.min.js',
        async: true
    });
    $.ajax({
        url: 'content/js/l10n/ej.localetexts.' + $("#culture_switcher").val() + '.min.js',
        async: false
    });
            ...
            if (control == "unobtrusive") {
                ...
                $.ajax({
                    ...
                    success: function (str, status, xhr) {
                        ...
                        str = str.replace(new RegExp("../css/images", 'g'), "content/images");
                        $("#samplefile").html(str);
                        setTimeout(function () {
