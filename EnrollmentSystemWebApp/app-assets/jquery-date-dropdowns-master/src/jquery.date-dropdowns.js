;(function ($, window, document, undefined) {
    ...
    var pluginName = 'dateDropdowns',
        pluginDefaults = {
            ...
            monthLongValuesES: ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'],
            ...
            for (var monthNo = 1; monthNo <= 12; monthNo++) {
                ...
                switch (this.config.monthFormat) {
                    ...
                    case 'long':
                        ...
                        {
                            month = this.config.monthLongValuesES[monthNo - 1];
                        }
